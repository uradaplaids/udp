...
Serial.println("handleList triggered");
#ifdef DEBUG_WEB
...
const char fshtml1[] PROGMEM =  R"=====(
    ...
    let sortBy = JSON.parse(localStorage.getItem('sortBy')); if (sortBy === null || typeof sortBy !== "number") sortBy = 0; list(sortBy); 
...
const char fshtml2[] PROGMEM =  R"=====(
  <form id="uploadForm" method="post" action="/upload" enctype="multipart/form-data">
    ...
    <button id="up" type="submit" disabled>Upload</button>
  </form>
...
void handleFSExplorer() {
  ...
  else
  {
    ...
    message += F("</form>");
    message += F("<main><p style=\"color:gray;\">Lade Dateien …</p></main>\n");
    message += F("<main></main>\n");

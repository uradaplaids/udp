...
******************************************************************************
20251031:
-Überarbeitung GUI, neu mit clear und Dark-Mode. Navigation optimiert.
-Alle Text Bausteine sind als String integiert. Modulare Sprachanpassung
-Wochentagsanzeige neu über Frontcoverauswahl
-Aktive Events werden in Fett-Scrift angezeigt.
-Nachdem ein Event gespeichert wurde, erscheint ein Feedback

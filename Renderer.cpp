...
#include "Languages.h"
//*****************************************************************************
// Mapping: FrontCover → sWeekdayTable Index
//*****************************************************************************
eFrontCover currentFrontcover = FRONTCOVER_CH_GR; // Defaultwert
uint8_t getCurrentWeekdayIndex();
uint8_t getWeekdayTableIndex(eFrontCover cover) {
  switch (cover) {
    ...
    case FRONTCOVER_GR_MLX:
    case FRONTCOVER_GR_LXM:
    case FRONTCOVER_GR_LXMb:
    case FRONTCOVER_GR_LXMc:
    case FRONTCOVER_GR_TMLX:
    case FRONTCOVER_GR_TLXM:
    case FRONTCOVER_GR_TLXMb:
    case FRONTCOVER_GR_TLXMc:
      return 2;

    case FRONTCOVER_EN: return 3;
    case FRONTCOVER_FR: return 4;
    case FRONTCOVER_IT: return 5;
    case FRONTCOVER_ES: return 6;
    case FRONTCOVER_NL: return 7;

    default: return 0; // Fallback auf CH
  }

}
uint8_t getCurrentWeekdayIndex() {
  return getWeekdayTableIndex(currentFrontcover);
}
Renderer::Renderer()
{
}
...
void Renderer::clearEntryWords(uint8_t language, uint16_t matrix[])
{
  ...
  case FRONTCOVER_CH_GR:
    ...
    break;
    case FRONTCOVER_GR_MLX:
    RM_MLX_IGL_EI_R; // remove IGL EI
    break;
  case FRONTCOVER_GR_TMLX:
    RM_MLX_IGL_EI_R; // remove IGL EI
    break;
  case FRONTCOVER_GR_LXM:
    RM_LXM_IGL_EI_R; // remove IGL EI
    break;
  case FRONTCOVER_GR_TLXM:
    RM_LXM_IGL_EI_R; // remove IGL EI
    break;
  case FRONTCOVER_GR_LXMb:
    RM_LXMb_IGL_EI_R; // remove IGL EI
    break;
    case FRONTCOVER_GR_TLXMb:
  RM_LXMb_IGL_EI_R; // remove IGL EI
    break;
    case FRONTCOVER_GR_LXMc:
  RM_LXMc_IGL_EI_R; // remove IGL EI
    break;
    case FRONTCOVER_GR_TLXMc:
  RM_LXMc_IGL_EI_R; // remove IGL EI
    break;

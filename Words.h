...
#define CH_AG_VIERTU     matrix[1] |= 0b1111110000000000
...
#define CH_AG_H_FUEFI      matrix[5] |= 0b0000000111100000
#define CH_AG_H_SAECHSI    matrix[6] |= 0b1111110000000000
#define CH_AG_H_SIEBNI     matrix[7] |= 0b0000001111100000
#define CH_AG_H_ACHTI      matrix[7] |= 0b1111100000000000
#define CH_AG_H_NUENI      matrix[6] |= 0b0000000111100000
...
#define CH_GR_H_EIS      matrix[4] |= 0b000000011100000
...
#define  RM_MLX_AM               matrix[0] |= 0b1000000000000000
#define  RM_MLX_PM               matrix[0] |= 0b0100000000000000
#define  RM_MLX_IGL_EI_BM        0b1110110000000000
#define  RM_MLX_IGL_EI           matrix[0] |=  RM_MLX_IGL_EI_BM
#define  RM_MLX_IGL_EI_R         matrix[0] &= ~ RM_MLX_IGL_EI_BM
#define  RM_MLX_VEGN             matrix[0] |= 0b0000000111100000
#define  RM_MLX_TGA              matrix[1] |= 0b1110000000000000
#define  RM_MLX_TSCHUN           matrix[1] |= 0b0001111110000000
#define  RM_MLX_IN               matrix[1] |= 0b0000000001100000
#define  RM_MLX_DIESCH           matrix[2] |= 0b1111110000000000
#define  RM_MLX_QUART            matrix[2] |= 0b0000001111100000
#define  RM_MLX_AVON             matrix[3] |= 0b1111000000000000
#define  RM_MLX_VARGAU           matrix[3] |= 0b0000011111100000
#define  RM_MLX_MESA             matrix[4] |= 0b1111000000000000
#define  RM_MLX_LINA             matrix[4] |= 0b0000011110000000
#define  RM_MLX_LAS              matrix[5] |= 0b1110000000000000
#define  RM_MLX_ENDISCH          matrix[5] |= 0b0000111111100000
#define  RM_MLX_DUDISCH          matrix[6] |= 0b1111111000000000
#define  RM_MLX_DUAS             matrix[6] |= 0b0000000111100000
#define  RM_MLX_SIAT             matrix[7] |= 0b1111000000000000
#define  RM_MLX_QUATER           matrix[7] |= 0b0000111111000000
#define  RM_MLX_DIESCH_plein     matrix[8] |= 0b1111110000000000
#define  RM_MLX_TREIS            matrix[8] |= 0b0000001111100000
#define  RM_MLX_TSCHUN_plein     matrix[9] |= 0b1111110000000000
#define  RM_MLX_NOV              matrix[9] |= 0b0000011100000000
#define  RM_MLX_OTG              matrix[9] |= 0b0000000011100000
#define  RM_MLX_S                matrix[6] |= 0b0000000000100000
#define  RM_MLX_I                matrix[7] |= 0b0000000000100000
#define  RM_MLX_S_               matrix[8] |= 0b0000000000100000

//RM_LXM

#define RM_LXM_AM               matrix[0] |= 0b1000000000000000
#define RM_LXM_PM               matrix[0] |= 0b0100000000000000
#define RM_LXM_IGL_EI_BM        0b1110110000000000
#define RM_LXM_IGL_EI           matrix[0] |= RM_LXM_IGL_EI_BM
#define RM_LXM_IGL_EI_R         matrix[0] &= ~RM_LXM_IGL_EI_BM
#define RM_LXM_VEGN             matrix[0] |= 0b0000000111100000
#define RM_LXM_TGA              matrix[1] |= 0b1110000000000000
#define RM_LXM_TSCHUN           matrix[1] |= 0b0001111110000000
#define RM_LXM_IN               matrix[1] |= 0b0000000001100000
#define RM_LXM_DIESCH           matrix[2] |= 0b1111110000000000
#define RM_LXM_QUART            matrix[2] |= 0b0000001111100000
#define RM_LXM_AVON             matrix[3] |= 0b1111000000000000
#define RM_LXM_VARGAU           matrix[3] |= 0b0000011111100000
#define RM_LXM_LAS              matrix[4] |= 0b1110000000000000
#define RM_LXM_QUATER           matrix[4] |= 0b0000111111000000
#define RM_LXM_LINA             matrix[5] |= 0b1111000000000000
#define RM_LXM_DUDISCH          matrix[5] |= 0b0000111111100000
#define RM_LXM_ENDISCH          matrix[6] |= 0b1111111000000000
#define RM_LXM_SIAT             matrix[6] |= 0b0000000111100000
#define RM_LXM_TREIS            matrix[7] |= 0b1111100000000000
#define RM_LXM_DIESCH_plein     matrix[7] |= 0b0000011111100000
#define RM_LXM_TSCHUN_plein     matrix[8] |= 0b1111110000000000
#define RM_LXM_NOV              matrix[8] |= 0b0000011100000000
#define RM_LXM_OTG              matrix[8] |= 0b0000000011100000
#define RM_LXM_DUAS             matrix[9] |= 0b1111000000000000
#define RM_LXM_S                matrix[5] |= 0b0000000010000000
#define RM_LXM_I                matrix[6] |= 0b0000000010000000
#define RM_LXM_S_               matrix[7] |= 0b0000000010000000
#define RM_LXM_MESA             matrix[9] |= 0b0000000111100000
#define RM_LXM_E_MESA           matrix[9] |= 0b0000010111100000

//RM_LXMb

#define RM_LXMb_AM               matrix[0] |= 0b1000000000000000
#define RM_LXMb_PM               matrix[0] |= 0b0100000000000000
#define RM_LXMb_IGL_EI_BM        0b1110110000000000
#define RM_LXMb_IGL_EI           matrix[0] |= RM_LXMb_IGL_EI_BM
#define RM_LXMb_IGL_EI_R         matrix[0] &= ~RM_LXMb_IGL_EI_BM
#define RM_LXMb_VEGN             matrix[0] |= 0b0000000111100000
#define RM_LXMb_TGA              matrix[1] |= 0b1110000000000000
#define RM_LXMb_TSCHUN           matrix[1] |= 0b0001111110000000
#define RM_LXMb_IN               matrix[1] |= 0b0000000001100000
#define RM_LXMb_DIESCH           matrix[2] |= 0b1111110000000000
#define RM_LXMb_QUART            matrix[2] |= 0b0000001111100000
#define RM_LXMb_AVON             matrix[3] |= 0b1111000000000000
#define RM_LXMb_VARGAU           matrix[3] |= 0b0000011111100000
#define RM_LXMb_LAS              matrix[4] |= 0b1110000000000000
#define RM_LXMb_DUDISCH          matrix[4] |= 0b0000111111100000
#define RM_LXMb_S                matrix[4] |= 0b0000000010000000
#define RM_LXMb_ENDISCH          matrix[5] |= 0b1111111000000000
#define RM_LXMb_SIAT             matrix[5] |= 0b0000000111100000
#define RM_LXMb_I                matrix[5] |= 0b0000000010000000
#define RM_LXMb_LINA             matrix[6] |= 0b1111000000000000
#define RM_LXMb_DIESCH_plein     matrix[6] |= 0b0000011111100000
#define RM_LXMb_S_               matrix[6] |= 0b0000000010000000
#define RM_LXMb_TSCHUN_plein     matrix[7] |= 0b1111110000000000
#define RM_LXMb_NOV              matrix[7] |= 0b0000011100000000
#define RM_LXMb_OTG              matrix[7] |= 0b0000000011100000
#define RM_LXMb_QUATER           matrix[8] |= 0b1111110000000000
#define RM_LXMb_TREIS            matrix[8] |= 0b0000001111100000
#define RM_LXMb_DUAS             matrix[9] |= 0b1111000000000000
#define RM_LXMb_E                matrix[9] |= 0b0000010000000000
#define RM_LXMb_MESA             matrix[9] |= 0b0000000111100000
#define RM_LXMb_E_MESA           matrix[9] |= 0b0000010111100000

//RM_LXMc

#define RM_LXMc_AM               matrix[0] |= 0b1000000000000000
#define RM_LXMc_PM               matrix[0] |= 0b0100000000000000
#define RM_LXMc_IGL_EI_BM        0b1110110000000000
#define RM_LXMc_IGL_EI           matrix[0] |= RM_LXMc_IGL_EI_BM
#define RM_LXMc_IGL_EI_R         matrix[0] &= ~RM_LXMc_IGL_EI_BM
#define RM_LXMc_VEGN             matrix[0] |= 0b0000000111100000
#define RM_LXMc_TGA              matrix[1] |= 0b1110000000000000
#define RM_LXMc_TSCHUN           matrix[1] |= 0b0001111110000000
#define RM_LXMc_IN               matrix[1] |= 0b0000000001100000
#define RM_LXMc_DIESCH           matrix[2] |= 0b1111110000000000
#define RM_LXMc_QUART            matrix[2] |= 0b0000001111100000
#define RM_LXMc_AVON             matrix[3] |= 0b1111000000000000
#define RM_LXMc_VARGAU           matrix[3] |= 0b0000011111100000
#define RM_LXMc_LAS              matrix[4] |= 0b1110000000000000
#define RM_LXMc_LINA             matrix[4] |= 0b0001111000000000
#define RM_LXMc_DUAS             matrix[4] |= 0b0000000111100000
#define RM_LXMc_TREIS            matrix[5] |= 0b1111100000000000
#define RM_LXMc_SIS              matrix[5] |= 0b0000111000000000
#define RM_LXMc_OTG              matrix[5] |= 0b0000000011100000
#define RM_LXMc_TSCHUN_plein     matrix[6] |= 0b1111110000000000
#define RM_LXMc_NOV              matrix[6] |= 0b0000011100000000
#define RM_LXMc_DUD              matrix[6] |= 0b0000000011100000
#define RM_LXMc_DU               matrix[7] |= 0b1100000000000000
#define RM_LXMc_DIE              matrix[7] |= 0b0011100000000000
#define RM_LXMc_ENDISCH          matrix[7] |= 0b0000111111100000
#define RM_LXMc_ISCH             matrix[7] |= 0b0000000111100000
#define RM_LXMc_DISCH            matrix[8] |= 0b1111100000000000
#define RM_LXMc_SCH              matrix[8] |= 0b0011100000000000
#define RM_LXMc_QUATER           matrix[8] |= 0b0000011111100000
#define RM_LXMc_SIAT             matrix[9] |= 0b1111000000000000
#define RM_LXMc_MESA             matrix[9] |= 0b0000000111100000
#define RM_LXMc_E_MESA           matrix[9] |= 0b0000010111100000
